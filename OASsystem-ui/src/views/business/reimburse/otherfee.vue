  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      ...
      <el-form-item label="项目名称" prop="otherFeeName">
        <el-input
          v-model="queryParams.otherFeeName"
          placeholder="请输入项目名称"
          clearable
          size="small"
          @keyup.enter.native="handleQuery"
    ...
    <el-table v-loading="loading" :data="feeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="主键id" align="center" prop="otherId" />
      <el-table-column label="报销id" align="center" prop="reimburseId" />
      <el-table-column label="项目名称" align="center" prop="otherFeeName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="项目名称" prop="otherFeeName">
          <el-input v-model="form.otherFeeName" placeholder="请输入项目名称" />
        </el-form-item>
        <el-form-item label="金额" prop="amount">
  ...
  methods: {
    ...
    submitForm: function() {
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.otherId != undefined) {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除其他费用编号为"' + otherIds + '"的数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
          return delFee(otherIds);
        }).then(() => {
          this.getList();
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有其他费用数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
