...
//				value = StringUtil.isNotBlank(value) && !"nil".equalsIgnoreCase(value) ? value : null;
    ...
    public String set(String key, String value, long cacheSeconds) {
        ...
        try {
            jedis = jedisPool.getResource();
            result = jedis.psetex(key,cacheSeconds, value);
    ...
    public String setObject(String key, Object value, int cacheSeconds) {
        ...
        try {
            ...
            if (cacheSeconds != 0) {
                jedis.expire(JSON.toJSONBytes(key), cacheSeconds);
            }
    ...
    public long delObject(String key) {
        ...
        try {
            jedis = jedisPool.getResource();
            byte[] keyvalue = JSON.toJSONBytes(key);
            if (jedis.exists(keyvalue)){
                result = jedis.del(keyvalue);
