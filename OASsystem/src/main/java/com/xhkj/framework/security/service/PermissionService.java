package com.xhkj.framework.security.service;
...
public class PermissionService
{
    ...
    {
        boolean hasPermission = permissions.contains(ALL_PERMISSION) || permissions.contains(StringUtils.trim(permission));
        if (!hasPermission) {
            log.info("不允许访问该权限" + permission);
        }
